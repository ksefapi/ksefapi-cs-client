...
namespace KsefApi.Model
{
    ...
    public partial class Podmiot2
    {
        ...
        public Podmiot2(string nrEORI = default, TPodmiot2 daneIdentyfikacyjne = default, TAdres adres = default, TAdres adresKoresp = default, List<DaneKontaktowe> daneKontaktowe = default, string nrKlienta = default, string iDNabywcy = default)
        {
            this.NrEORI = nrEORI;
