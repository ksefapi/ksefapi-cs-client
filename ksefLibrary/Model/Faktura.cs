...
namespace KsefApi.Model
{
    ...
    public partial class Faktura
    {
        ...
        /// <param name="zalacznik">zalacznik.</param>
        public Faktura(TNaglowek naglowek = default, Podmiot1 podmiot1 = default, Podmiot2 podmiot2 = default, List<Podmiot3> podmiot3 = default, PodmiotUpowazniony podmiotUpowazniony = default, Fa fa = default, Stopka stopka = default, FakturaZalacznik zalacznik = default)
        {
        ...
        /// </summary>
        [DataMember(Name = "Zalacznik", EmitDefaultValue = false)]
        public FakturaZalacznik Zalacznik { get; set; }
