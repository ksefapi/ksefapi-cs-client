...
namespace KsefApi.Model
{
    ...
    public partial class Transport
    {
        ...
        /// <param name="transportInny">Single-choice field.</param>
        /// <param name="opisInnegoTransportu">String type limited to 50 characters.</param>
        /// <param name="przewoznik">przewoznik.</param>
        /// <param name="nrZleceniaTransportu">String type limited to 256 characters.</param>
        /// <param name="opisLadunku">opisLadunku.</param>
        /// <param name="ladunekInny">Single-choice field.</param>
        /// <param name="opisInnegoLadunku">String type limited to 50 characters.</param>
        /// <param name="jednostkaOpakowania">String type limited to 256 characters.</param>
        /// <param name="dataGodzRozpTransportu">Event date and time in the period from 2021-10-01T00:00:00Z to 2050-01-01T23:59:59Z.</param>
        /// <param name="dataGodzZakTransportu">Event date and time in the period from 2021-10-01T00:00:00Z to 2050-01-01T23:59:59Z.</param>
