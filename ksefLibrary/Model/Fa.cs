...
namespace KsefApi.Model
{
    ...
    public partial class Fa
    {
        ...
        /// <param name="p1">Event date in the period from 2006-01-01 to 2050-01-01.</param>
        /// <param name="p1M">String type limited to 256 characters.</param>
        /// <param name="p2">String type limited to 256 characters.</param>
        /// <param name="wZ">wZ.</param>
        /// <param name="p131">Numeric value, max 18 digits including 2 decimal places.</param>
        /// <param name="p141">Numeric value, max 18 digits including 2 decimal places.</param>
        /// <param name="p141W">Numeric value, max 18 digits including 2 decimal places.</param>
        /// <param name="p132">Numeric value, max 18 digits including 2 decimal places.</param>
        /// <param name="p142">Numeric value, max 18 digits including 2 decimal places.</param>
        /// <param name="p142W">Numeric value, max 18 digits including 2 decimal places.</param>
        /// <param name="p133">Numeric value, max 18 digits including 2 decimal places.</param>
        /// <param name="p143">Numeric value, max 18 digits including 2 decimal places.</param>
        /// <param name="p143W">Numeric value, max 18 digits including 2 decimal places.</param>
        /// <param name="p134">Numeric value, max 18 digits including 2 decimal places.</param>
        /// <param name="p144">Numeric value, max 18 digits including 2 decimal places.</param>
        /// <param name="p144W">Numeric value, max 18 digits including 2 decimal places.</param>
        /// <param name="p135">Numeric value, max 18 digits including 2 decimal places.</param>
        /// <param name="p145">Numeric value, max 18 digits including 2 decimal places.</param>
        /// <param name="p1361">Numeric value, max 18 digits including 2 decimal places.</param>
        /// <param name="p1362">Numeric value, max 18 digits including 2 decimal places.</param>
        /// <param name="p1363">Numeric value, max 18 digits including 2 decimal places.</param>
        /// <param name="p137">Numeric value, max 18 digits including 2 decimal places.</param>
        /// <param name="p138">Numeric value, max 18 digits including 2 decimal places.</param>
        /// <param name="p139">Numeric value, max 18 digits including 2 decimal places.</param>
        /// <param name="p1310">Numeric value, max 18 digits including 2 decimal places.</param>
        /// <param name="p1311">Numeric value, max 18 digits including 2 decimal places.</param>
        /// <param name="p15">Numeric value, max 18 digits including 2 decimal places.</param>
        /// <param name="kursWalutyZ">Type used to specify quantity. Numeric value, max 22 digits including 6 decimal places.</param>
        /// <param name="adnotacje">adnotacje.</param>
        /// <param name="rodzajFaktury">rodzajFaktury.</param>
        /// <param name="przyczynaKorekty">String type limited to 256 characters.</param>
        /// <param name="typKorekty">typKorekty.</param>
        /// <param name="daneFaKorygowanej">daneFaKorygowanej.</param>
        /// <param name="okresFaKorygowanej">String type limited to 256 characters.</param>
        /// <param name="nrFaKorygowany">String type limited to 256 characters.</param>
        /// <param name="podmiot1K">podmiot1K.</param>
        /// <param name="podmiot2K">podmiot2K.</param>
        /// <param name="p15ZK">Numeric value, max 18 digits including 2 decimal places.</param>
        /// <param name="kursWalutyZK">Type used to specify quantity. Numeric value, max 22 digits including 6 decimal places.</param>
        /// <param name="zaliczkaCzesciowa">zaliczkaCzesciowa.</param>
        /// <param name="fP">Single-choice field.</param>
        /// <param name="tP">Single-choice field.</param>
        /// <param name="dodatkowyOpis">dodatkowyOpis.</param>
        /// <param name="fakturaZaliczkowa">fakturaZaliczkowa.</param>
        /// <param name="zwrotAkcyzy">Single-choice field.</param>
        ...
        /// <param name="p6Od">Event date in the period from 2006-01-01 to 2050-01-01.</param>
        /// <param name="p6Do">Event date in the period from 2006-01-01 to 2050-01-01.</param>
